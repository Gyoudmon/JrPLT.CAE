...
std::vector<std::pair<char, std::string>> WarGrey::IMS::ClearMenu::prepare_menu_items() {
    return {
...
void WarGrey::IMS::ClearMenu::on_menu_key(IMenuEventListener* master, MenuType self, char key) {
    switch (key) {
