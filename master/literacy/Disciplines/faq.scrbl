...
以上几个纬度不会单独存在，同一个人往往会同时属于好几个纬度，
差别在于各个纬度的比例不同。由此也可以看到，
...
电视机和烟花都符合条件；键盘是可以按的积木，
孩子或许会觉得这是个减压玩具。
再比如，我们已经接触到了一些孩子，
他们声称自己极度抗拒信息类课程，
然后转身就沉浸在魔方、汉诺塔这类实体策略玩具中无法自拔。
可这些玩具的玩法都是算法学习过程中的经典例题啊。
唯一判断孩子是否感兴趣的方法只有“真的去学”，
而且老师的眼界和教学的实施过程很重要，
否则极易消耗孩子的耐心。
对预备技能要求高而导致孩子很难在初期就体验到学习的快乐。

对于中小学生而言，家长在决定是否让孩子学编程的时候，动机可以不那么功利。
因为无论家长怎么想，孩子学成能够收获的好处都绝对远超预期。
@racketoutput{没有相关的“收获体验”的家长，
 不可能真的看懂网络上的“学编程有什么好处”。
 家长可以跟孩子一起学。}
